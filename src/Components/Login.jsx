...
const Login = () => {
  ...
  return (
    <div>
      ...
      <form className='absolute px-20 py-14 bg-black/80 w-4/12 h-auto mx-auto my-26 right-0 left-0'>
        ...
        <input type="text" name="" id="" placeholder='Email address' className='p-3 mt-4 mb-2 bg-gray-700 text-white w-full'/>
        <input type="text" name="" id="" placeholder='PassWord' className='p-3 mt-2 mb-2 bg-gray-700 text-white w-full'/>
        <button className='p-2 mt-2 mb-2 w-full text-white bg-red-700'>{isSignInForm ? "Sign In" : "Sign Up"}</button>
